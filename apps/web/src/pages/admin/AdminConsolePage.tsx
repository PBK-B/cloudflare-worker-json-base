...
import { useConsoleApi } from '../../features/console/api';
...
const AdminConsolePage: React.FC = () => {
	...
	const { getConsoleStats } = useConsoleApi();
			...
			<div className={styles.adminSection}>
				...
				<div className={styles.consoleCardCode}>
						...
						<pre className={styles.consoleCodeBlock}>
							{t('console.quickApiSample', { defaultValue: '创建数据:\nPOST /._jsondb_/api/admin/resources/example\nAuthorization: Bearer YOUR_API_KEY\n{"type":"json","value":{"name":"example"}}\n\n获取数据:\nGET /example\nAuthorization: Bearer YOUR_API_KEY\n-> {"name":"example"}\n' })}
						</pre>
					</div>
				</div>
			</div>
